...
timerHardware_t timerHardware[] = {
	...
	DEF_TIM(TMR4, CH1, PB6,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_MC_SERVO, 0,11), 	// PWM3 - OUT3  DMA1 CH7
	DEF_TIM(TMR4, CH2, PB7,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_MC_SERVO, 0,10), 	// PWM4 - OUT4  DMA2 CH1
	DEF_TIM(TMR3, CH4, PB1,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_MC_SERVO, 0,9), 		// PWM5 - OUT5  DMA2 CH2
	DEF_TIM(TMR3, CH3, PB0,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO | TIM_USE_MC_SERVO, 0,8), 		// PWM6 - OUT6  DMA2 CH3
