...
#define IOCFG_OUT_PP         IO_CONFIG(GPIO_MODE_OUTPUT, 0, GPIO_OUTPUT_PUSH_PULL, GPIO_PULL_NONE)  // TODO
#define IOCFG_OUT_PP_25      IO_CONFIG(GPIO_MODE_OUTPUT, 0, GPIO_OUTPUT_PUSH_PULL, GPIO_PULL_NONE)
#define IOCFG_OUT_OD         IO_CONFIG(GPIO_MODE_OUTPUT, 0, GPIO_OUTPUT_OPEN_DRAIN, GPIO_PULL_NONE)
#define IOCFG_AF_PP_FAST     IO_CONFIG(GPIO_MODE_MUX,  0, GPIO_OUTPUT_PUSH_PULL, GPIO_PULL_DOWN)
#define IOCFG_AF_PP          IO_CONFIG(GPIO_MODE_MUX,  0, GPIO_OUTPUT_PUSH_PULL, GPIO_PULL_NONE)
#define IOCFG_AF_PP_PD       IO_CONFIG(GPIO_MODE_MUX,  0, GPIO_OUTPUT_PUSH_PULL, GPIO_PULL_DOWN)
#define IOCFG_AF_PP_UP       IO_CONFIG(GPIO_MODE_MUX,  0, GPIO_OUTPUT_PUSH_PULL, GPIO_PULL_UP)
#define IOCFG_AF_OD          IO_CONFIG(GPIO_MODE_MUX,  0, GPIO_OUTPUT_OPEN_DRAIN, GPIO_PULL_NONE)
#define IOCFG_AF_OD_UP       IO_CONFIG(GPIO_MODE_MUX,  0, GPIO_OUTPUT_OPEN_DRAIN, GPIO_PULL_UP)
#define IOCFG_IPD            IO_CONFIG(GPIO_MODE_INPUT,  0, 0,             GPIO_PULL_DOWN)
#define IOCFG_IPU            IO_CONFIG(GPIO_MODE_INPUT,  0, 0,             GPIO_PULL_UP)
